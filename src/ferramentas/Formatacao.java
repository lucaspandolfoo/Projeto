...
public class Formatacao {
    ...
    /* public static void formatarData(JFormattedTextField data) {
        try {
            ...
            CaixaDeDialogo.obterinstancia().exibirMensagem("Erro ao formatar a data!" + ex.getMessage().toString(), "Data", 'e');          
        }
    }*/
}
